...
from duco.const import (
    DUCO_MODULE_TYPE_MASTER,
    DUCO_MODULE_TYPE_VALVE_SENSORLESS,
    DUCO_MODULE_TYPE_VALVE_CO2,
    DUCO_MODULE_TYPE_VALVE_RH,
    DUCO_MODULE_TYPE_USER_CONTROLLER,
    DUCO_MODULE_TYPE_ROOM_SENSOR_CO2,
    DUCO_MODULE_TYPE_ROOM_SENSOR_RH,
    DUCO_MODULE_TYPE_CTRL_WINDOW_VENT,
    DUCO_MODULE_TYPE_ROOM_SWITCH,
    DUCO_MODULE_TYPE_ACTUATOR_PRINT,
    DUCO_ZONE_STATUS_AUTO,
    DUCO_ZONE_STATUS_HIGH_10MIN,
    DUCO_ZONE_STATUS_HIGH_20MIN,
    DUCO_ZONE_STATUS_HIGH_30MIN,
    DUCO_ZONE_STATUS_MANUAL_LOW,
    DUCO_ZONE_STATUS_MANUAL_MEDIUM,
    DUCO_ZONE_STATUS_MANUAL_HIGH,
    DUCO_ZONE_STATUS_AWAY,
    DUCO_ZONE_STATUS_ERROR,
    DUCO_ACTION_NODE_VISIBILITY_OFF,
    DUCO_ACTION_NODE_VISIBILITY_ON,
    DUCO_ACTION_ZONE_TO_MANUAL_1,
    DUCO_ACTION_ZONE_TO_MANUAL_2,
    DUCO_ACTION_ZONE_TO_MANUAL_3,
    DUCO_ACTION_ZONE_TO_AUTO,
    DUCO_ACTION_AWAY
)
