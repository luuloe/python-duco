...
DUCO_MODBUS_DEFAULT_MASTER_ADDRESS = 1

# duco zone status
DUCO_ZONE_STATUS_AUTO = 0
DUCO_ZONE_STATUS_HIGH_10MIN = 1
DUCO_ZONE_STATUS_HIGH_20MIN = 2
DUCO_ZONE_STATUS_HIGH_30MIN = 3
DUCO_ZONE_STATUS_MANUAL_LOW = 4
DUCO_ZONE_STATUS_MANUAL_MEDIUM = 5
DUCO_ZONE_STATUS_MANUAL_HIGH = 6
DUCO_ZONE_STATUS_AWAY = 7
DUCO_ZONE_STATUS_ERROR = 99
...
# scale factors (register to actual)
DUCO_SCALE_FACTOR_TEMPERATURE = 0.1
DUCO_SCALE_FACTOR_RH = 0.01
...
# duco action
DUCO_ACTION_NODE_VISIBILITY_OFF = 0
DUCO_ACTION_NODE_VISIBILITY_ON = 1
DUCO_ACTION_ZONE_TO_MANUAL_1 = 2
DUCO_ACTION_ZONE_TO_MANUAL_2 = 3
DUCO_ACTION_ZONE_TO_MANUAL_3 = 4
DUCO_ACTION_ZONE_TO_AUTO = 5
DUCO_ACTION_AWAY = 6
